        ...
        <div class="flex flex-col">
            <div class="-m-1.5 overflow-x-auto">
                ...
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-100 dark:border-neutral-700">
                    ...
                    <!-- End Header -->
                    <form action="{{ route('tips-makanan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div>
                            <div>
                                <div class="py-5 px-6">
                                ...
                                <div class="py-5 px-6">
                                    ...
                                    <div class="max-w-sm">
                                        ...
                                        <textarea name="judul" id="textarea-email-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" rows="3" placeholder="Ketik Judul Disini..."></textarea>
                                    </div>
                                    @error('judul')
                                        <div class="text-red-500">{{ $message }}</div>
                                    @enderror
